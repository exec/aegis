...
/* ---- Dark mode palette (blue tinge) ---- */
#define C_BG1       0x001B2838
#define C_BG2       0x000D1B2A
#define C_BAR       0x001A1A2E
#define C_BAR_T     0x00C0C0D0
#define C_WIN       0x00E8E8F0   /* primary text on dark backgrounds */
#define C_WIN_BG    0x00222838   /* widget surface / card background */
...
#define C_TEXT      0x00E0E0E8   /* dark-mode text (was 0x202030 in light) */
#define C_RED       0x00FF5F57
#define C_GREEN     0x0028C840
#define C_YELLOW    0x00FEBC2E
...
#define C_INPUT_BD  0x00404860   /* text field / list border */
#define C_SEL_BG    0x00305880   /* selection / hover highlight */
