...
/* KVA bump allocator base — past the 256MB block-mapped region + window.
 * Block mappings: L2[0..127] = 256MB. Window: L2[128]. KVA: L2[129+]. */
#define ARCH_KVA_BASE (ARCH_KERNEL_VIRT_BASE + 0x10200000UL)  /* +258MB */
